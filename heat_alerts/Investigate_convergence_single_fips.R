...
CPQ_MR<- list.files("d3rlpy_logs", pattern = "June_SC_")
...
CPQ_MR_alerts<- list.files("Summer_results/", pattern = "June_SC")
...
CPQ_MR_pol<- list.files("Policies/", pattern = "Policy_June_SC")
