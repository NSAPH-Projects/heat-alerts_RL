...
DF<- read.csv("lightning_logs/R_no-past_hosps_adam_mse/version_0/metrics.csv")
DF<- read.csv("lightning_logs/R_no-past_other-hosps_adam_mse/version_0/metrics.csv")
