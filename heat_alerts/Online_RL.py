...
def main(params):
    ...
    #     n_epochs = 6, sa = 2, sync_rate = 3,
    #     b_size = 1530, lr = 0.1, gamma = 0.999,
    #     n_gpus = 0
    # )

    n_days=153
    n_years=10
    # n_steps_per_epoch=n_days*n_years
    ...
    dqn = algo(
        ...
        gamma=params["gamma"],
        target_update_interval=n_days*params["sync_rate"],
        scaler = None,
        reward_scaler = None
        )
    ...
    buffer = ReplayBuffer(maxlen=n_days*params["n_epochs"], env=env)

    # explorer = LinearDecayEpsilonGreedy(start_epsilon=1.0,
    #                                 end_epsilon=0.1,
    #                                 duration=n_days*params["n_epochs"]*0.5)
    ...
    dqn.fit_online(env,
               ...
               n_steps=n_days*params["n_epochs"],
               eval_env=eval_env,
