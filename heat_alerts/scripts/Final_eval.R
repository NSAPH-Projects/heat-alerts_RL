...
write.csv(results, paste0("Fall_results/Alert-rate_Final_eval_30_", prefix, ".csv"))
...
split2<- "FC-"
fc_N<- read.csv(paste0("Fall_results/Alert-rate_Final_eval_30_", r_model, "_FC-num_elig-w-rstr-hi.csv"))
fc_Q<- read.csv(paste0("Fall_results/Alert-rate_Final_eval_30_", r_model, "_FC-quantiles-w-rstr-hi.csv"))
fc_D10<- read.csv(paste0("Fall_results/Alert-rate_Final_eval_30_", r_model, "_FC-ten_day-w-rstr-hi.csv"))
fc_Av4<- read.csv(paste0("Fall_results/Alert-rate_Final_eval_30_", r_model, "_FC-quarters-w-rstr-hi.csv"))
fc_All<- read.csv(paste0("Fall_results/Alert-rate_Final_eval_30_", r_model, "_FC-all-w-rstr-hi.csv"))
...
results[,c("Eval")]<- round(results[,c("Eval")],3)
results
write.csv(results, paste0("Fall_results/Alert-rate_Final_eval_30_TK.csv"))
...
results[,c("Eval")]<- round(results[,c("Eval")],3)
results
write.csv(results, paste0("Fall_results/Alert-rate_Final_eval_30_", r_model, "_", pol, "-w-rstr-hi.csv"))
...
wilcox.test(results$Eval, earlier$NWS, paired = TRUE, alternative = "greater", exact=FALSE)
# wilcox.test(earlier$Eval, earlier$NWS, paired = TRUE, alternative = "greater", exact=FALSE)
...
wilcox.test(results$Eval_DQN, earlier$NWS, paired = TRUE, alternative = "greater", exact=FALSE)
wilcox.test(results$Eval_TRPO, earlier$NWS, paired = TRUE, alternative = "greater", exact=FALSE)
